...
def init_db():
    ...
    try:
        # 1. Crear Roles
        roles = ["Administrador", "Medico", "Paciente", "Admisionista"]
        ...
        rol_admin = db.query(models.Rol).filter_by(nombre="Administrador").first()
        ...
        usuarios_prueba = [
            models.Usuario(
                nombres="Admin", apellidos="Sistema", tipo_documento_id=doc_cc.id,
                numero_documento="1001", fecha_nacimiento=datetime.date(1980, 1, 1),
                genero="M", email="admin@hce.com", sede_id=sede_bog.id, rol_id=rol_admin.id,
                password_hash=password_generico
            ),
            models.Usuario(
                nombres="Pepito", apellidos="Perez (Medico)", tipo_documento_id=doc_cc.id,
            ...
            models.Usuario(
                nombres="Juanita", apellidos="Lopez (Paciente)", tipo_documento_id=doc_cc.id,
            ...
            models.Usuario(
                nombres="Carlos", apellidos="Gomez (Admision)", tipo_documento_id=doc_cc.id,
